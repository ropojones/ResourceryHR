...
public class ResourceryHRHostingModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            var cstr = configuration.GetConnectionString(ResourceryHRNames.RabbitMq);
    ...
    )
    {
        context.Services.AddSingleton<IDistributedLockProvider>(sp =>
        {
            var connection = ConnectionMultiplexer.Connect(
                configuration.GetConnectionString(ResourceryHRNames.Redis)!
            );
...
public static class HostingExtensions
{
    ...
    )
    {
        var dataProtectionBuilder = context
            ...
            .SetApplicationName(ResourceryHRNames.ResourceryHR);
