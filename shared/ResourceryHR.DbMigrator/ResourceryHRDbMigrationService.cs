...
public class ResourceryHRDbMigrationService(
    ILogger<ResourceryHRDbMigrationService> logger,
...
) : ITransientDependency
{
    ...
    private readonly ILogger<ResourceryHRDbMigrationService> _logger = logger;
