...
using ResourceryHR.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(ResourceryHRWebAppDomainSharedModule))]
...
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(ResourceryHRNames.AdministrationApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryHRNames.IdentityServiceApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryHRNames.SaaSApi);
            options.ProviderOptions.DefaultScopes.Add(ResourceryHRNames.WebAppApi);
        });
    }
